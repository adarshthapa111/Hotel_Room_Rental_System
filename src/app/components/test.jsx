  ...
  return (
    <main className="flex flex-col">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-gray-500 text-center">Stay connected with high-speed internet access in all rooms.</p>
            </div>
            <div className="flex flex-col items-center gap-4">
              <ParkingMeterIcon className="h-8 w-8 text-primary" />
              <h3 className="text-lg font-semibold">Free Parking</h3>
              <p className="text-gray-500 text-center">Complimentary parking for all guests.</p>
            </div>
            <div className="flex flex-col items-center gap-4">
              <SpadeIcon className="h-8 w-8 text-primary" />
              <h3 className="text-lg font-semibold">Spa & Wellness</h3>
              <p className="text-gray-500 text-center">Relax and rejuvenate at our on-site spa.</p>
            </div>
            <div className="flex flex-col items-center gap-4">
              <MenuIcon className="h-8 w-8 text-primary" />
              <h3 className="text-lg font-semibold">Dining Options</h3>
              <p className="text-gray-500 text-center">Enjoy a variety of dining experiences at our hotel.</p>
            </div>
          </div>
        </div>
      </section>
      <section className="py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold sm:text-4xl md:text-5xl">Explore Our Room Types</h2>
            <p className="mt-4 text-gray-500 md:text-xl">Find the perfect room for your stay.</p>
          </div>
            ...
            <div className="overflow-hidden rounded-lg shadow-lg transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
              <Link className="block" href="#">
                ...
                <div className="bg-white p-4 dark:bg-gray-950">
                  ...
                  <p className="text-gray-500">Comfortable and cozy room with a queen-size bed.</p>
            ...
            <div className="overflow-hidden rounded-lg shadow-lg transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
              <Link className="block" href="#">
                ...
                <div className="bg-white p-4 dark:bg-gray-950">
                  ...
                  <p className="text-gray-500">Spacious room with a king-size bed and city view.</p>
                  <div className="mt-4 flex items-center justify-between">
            ...
            <div className="overflow-hidden rounded-lg shadow-lg transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
              <Link className="block" href="#">
                ...
                <div className="bg-white p-4 dark:bg-gray-950">
                  ...
                  <p className="text-gray-500">Luxurious suite with a separate living area and balcony.</p>
                  <div className="mt-4 flex items-center justify-between">
      ...
      <section className="bg-gray-100 py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold sm:text-4xl md:text-5xl">What Our Guests Say</h2>
            <p className="mt-4 text-gray-500 md:text-xl">Read reviews from our satisfied customers.</p>
          </div>
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-lg bg-white p-6 shadow-lg dark:bg-gray-950">
              ...
              <div className="mt-4">
                ...
                <p className="mt-4 text-gray-500">
                  The hotel was amazing! The room was clean and comfortable, and the staff was incredibly friendly and
            ...
            <div className="rounded-lg bg-white p-6 shadow-lg dark:bg-gray-950">
              ...
              <div className="mt-4">
                ...
                <p className="mt-4 text-gray-500">
                  I had a wonderful stay at this hotel. The amenities were top-notch, and the staff went above and
                  beyond to make my experience exceptional.
                </p>
              </div>
            </div>
            <div className="rounded-lg bg-white p-6 shadow-lg dark:bg-gray-950">
              ...
              <div className="mt-4">
                ...
                <p className="mt-4 text-gray-500">
                  I had an amazing stay at this hotel. The location was perfect, and the room was incredibly
                  comfortable. I would highly recommend this place to anyone visiting the area.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-primary py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-4 md:px-6 text-center text-white">
          <h2 className="text-3xl font-bold sm:text-4xl md:text-5xl">Book Your Stay Today</h2>
          <p className="mt-4 md:text-xl">Experience the best of our hotel and make your vacation unforgettable.</p>
          <div className="mt-8">
            <Button
