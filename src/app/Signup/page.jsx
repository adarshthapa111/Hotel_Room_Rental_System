...
const Page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push("/login");
      toast.success("Sucessfully created your account");
    } catch (err) {
  ...
  return (
    <motion.div
      className="flex flex-1 flex-col justify-center px-6 py-2 lg:px-8 items-center bg-gray-100 min-h-screen mx-auto"
